          ...
          {titles.map((title) => (
            <div key={title.id} className="relative min-w-0 flex-[0_0_100%] px-4 sm:px-6 lg:px-8">
              <div className="relative aspect-[16/9] w-full overflow-hidden rounded-2xl border border-white/10 sm:aspect-[21/9]">
                ...
                <div className="absolute inset-x-0 bottom-0 flex flex-col gap-3 p-5 sm:p-8 md:max-w-xl">
      ...
      <div className="mt-4 flex justify-center gap-1.5">
        {titles.map((_, i) => (
          <button
            ...
            className={cn("h-1.5 rounded-full transition-all", selected === i ? "w-6 bg-accent" : "w-1.5 bg-white/20")}
